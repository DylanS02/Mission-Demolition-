...
public class Projectile : MonoBehaviour {
    ...
    void FixedUpdate() {
        ...
        // Limit lookback; one of the very few times that I'll use whil
        ...
        // If the Projectilehasn't moved more than the sleepThreshold
        if ( maxDelta <= Physics.sleepThreshold ) {
            // Set awake to false and put the Rigidbody to sleepThreshold
            awake = false;
            rigid.Sleep();
        }
    }
